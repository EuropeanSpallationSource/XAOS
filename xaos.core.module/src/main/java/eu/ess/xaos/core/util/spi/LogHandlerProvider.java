 ...
 */
package eu.ess.xaos.core.util.spi;


import java.util.logging.Level;
import eu.ess.xaos.core.util.LogHandler;
...
public interface LogHandlerProvider {
	 ...
	 *         {@link LogUtils#registerHandle(java.util.logging.Level, eu.ess.xaos.core.util.spi.LogHandler) register}
	 *         the handler.
	 */
	Level getLevel();
