 ...
 */
package eu.ess.xaos.tools.annotation.impl;
...
import eu.ess.xaos.tools.annotation.ServiceProviders;
import eu.ess.xaos.tools.lang.AbstractAnnotationProcessor;
...
@SupportedAnnotationTypes( {
	"eu.ess.xaos.tools.annotation.ServiceProvider",
	"eu.ess.xaos.tools.annotation.ServiceProviders"
} )
...
public class ServiceProviderProcessor extends AbstractAnnotationProcessor {
	...
	public Iterable<? extends Completion> getCompletions( Element annotated, AnnotationMirror annotation, ExecutableElement attr, String userText ) {
		...
		} else if ( annotation == null || !"eu.ess.xaos.tools.annotation.ServiceProvider".contentEquals(( (QualifiedNameable) annotation.getAnnotationType().asElement() ).getQualifiedName()) ) {
			return Collections.emptyList();
