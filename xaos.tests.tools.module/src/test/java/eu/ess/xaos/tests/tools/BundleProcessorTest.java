 ...
 */
package eu.ess.xaos.tests.tools;
...
import eu.ess.xaos.tests.tools.bundles.ClassA;
import eu.ess.xaos.tests.tools.bundles.ClassB;
import eu.ess.xaos.tests.tools.bundles.ClassC;
...
public class BundleProcessorTest {
	...
	public void testBundlesCreation() {
		...
		String resource = "eu.ess.xaos.tests.tools.bundles.Bundle";
		...
		resource = "eu.ess.xaos.tests.tools.bundles.Messages";
		...
		resource = "eu.ess.xaos.tests.tools.bundles.p1.LocalizedMessages";
		bundle = checkBundle(resource, 0);

		System.out.println("    " + resource);

		resource = "eu.ess.xaos.tests.tools.bundles.p1.Messages";
	...
	public void testMessageRetrieval() {
		...
		assertThat(Bundles.get(eu.ess.xaos.tests.tools.bundles.p1.ClassB.class, "staticFieldB1.default")).isEqualTo("Some initial static B1 value.");
		assertThat(Bundles.get(eu.ess.xaos.tests.tools.bundles.p1.ClassC.class, "methodCb.message", 123, 'A', "abc")).isEqualTo("Some Cb message [123, A, abc].");
